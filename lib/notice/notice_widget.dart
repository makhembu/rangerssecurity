...
class _NoticeWidgetState extends State<NoticeWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'notice'});
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'NOTICE_PAGE_Icon_w0d1n2x8_ON_TAP');
                ...
                children: [
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => StreamBuilder<List<NoticesRecord>>(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              valueOrDefault<String>(
                                                listViewNoticesRecord.photoUrl,
