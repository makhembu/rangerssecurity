...
import 'addvisitor_model.dart';
export 'addvisitor_model.dart';
...
class _AddvisitorWidgetState extends State<AddvisitorWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'addvisitor'});
    ...
    _model.carplatesTextController ??= TextEditingController();
    _model.carplatesFocusNode ??= FocusNode();

    _model.numberofvisitorsTextController ??= TextEditingController();
    _model.numberofvisitorsFocusNode ??= FocusNode();
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADDVISITOR_PAGE_Icon_l1r23j8k_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_navigate_to');
                                      ...
                                      child: Material(
                                        ...
                                        child: Container(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'ADDVISITOR_PAGE_UPLOAD_PHOTO_BTN_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'ADDVISITOR_PAGE_NEXT_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_page_view');
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.carplatesTextController,
                                      focusNode: _model.carplatesFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      validator: _model
                                          .carplatesTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                  Row(
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.numberofvisitorsTextController,
                                      focusNode:
                                          _model.numberofvisitorsFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ADDVISITOR_PAGE_Icon_0ev2ihe0_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'ADDVISITOR_PAGE_SUBMIT_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_backend_call');
                                              ...
                                              await visitorsRecordReference
                                                ...
                                                ...createVisitorsRecordData(
                                                  ...
                                                  numberofvisitors: _model
                                                      .numberofvisitorsTextController
                                                      .text,
                                                  visittime: _model.datePicked,
                                                  visittype:
                                                      _model.dropDownValue,
                                                  carPlates: _model
                                                      .carplatesTextController
                                                      .text,
                                                  photoUrl:
                                                      _model.uploadedFileUrl,
                                                  ischecked: false,
                                              ...
                                              _model.vistorout = VisitorsRecord
                                                  .getDocumentFromData({
                                                ...createVisitorsRecordData(
                                                  qid: _model
                                                      .idTextController.text,
                                              ...
                                              context.goNamed(
                                                'qrpage',
                                                queryParameters: {
                                                  'visitoref': serializeParam(
                                                    _model.vistorout?.reference,
