...
import 'addticket_model.dart';
export 'addticket_model.dart';
...
class _AddticketWidgetState extends State<AddticketWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'addticket'});
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ADDTICKET_PAGE_Icon_jclk2irk_ON_TAP');
                          ...
                          children: [
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ADDTICKET_PAGE_Column_l8pb3bs7_ON_TAP');
                                          logFirebaseEvent(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADDTICKET_PAGE_SUBMIT_BTN_ON_TAP');
                                  ...
                                  var ticketsRecordReference =
                                      TicketsRecord.collection.doc();
                                  await ticketsRecordReference.set({
