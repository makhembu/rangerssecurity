...
import 'updateemail_model.dart';
export 'updateemail_model.dart';
...
class _UpdateemailWidgetState extends State<UpdateemailWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'updateemail'});
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'UPDATEEMAIL_PAGE_Icon_yvxrs8eh_ON_TAP');
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'UPDATEEMAIL_PAGE_UPDATE_EMAIL_BTN_ON_TAP');
                          ...
                          if (_model.emailTextController2.text.isEmpty) {
